...
public class StudentMainActivity extends AppCompatActivity {
        ...
        lvCourseMessages.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapterView,
                        ...
                        Intent intent = new Intent(StudentMainActivity.this, StudentCourseDetailActivity.class);
    ...
    private void initData() {
        ...
        adapter = new CourseMessageAdapter(StudentMainActivity.this ,
    ...
    private void refreshData(final int page) {
        new Thread(new Runnable() {
            ...
            public void run() {
                Request request = new Request.Builder()
                        .url(Constants.baseUrl+"getCourseMessage/"+user_num)
                        .get().build();
                try {
                    //将调用接口得到的数据绑定上面的callback，callback在将数据绑定到新闻适配器
                    OkHttpClient client = new OkHttpClient();
    ...
    //弹窗方法
        ...
        final AlertDialog.Builder alterDiaglog = new AlertDialog.Builder(StudentMainActivity.this);
